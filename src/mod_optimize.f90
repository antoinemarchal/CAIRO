          ...
          do j=1, dim_y
             ...
             if (i .eq. 1) then             
                ...
                deriv(1+(3*(3-1)),j,l) = deriv(1+(3*(3-1)),j,l) - (lambda_r * &
                     ...
                     * (params(1+(3*(2-1)),j,l) / params(1+(3*(3-1)),j,l) - 0.33557_xp))                
                ...
                deriv(1+(3*(9-1)),j,l) = deriv(1+(3*(9-1)),j,l) - (lambda_r * &
                     ...
                     * (params(1+(3*(8-1)),j,l) / params(1+(3*(9-1)),j,l) - 0.33557_xp))                
                ...
                deriv(1+(3*(6-1)),j,l) = deriv(1+(3*(6-1)),j,l) - (lambda_r * &
                     ...
                     * (params(1+(3*(4-1)),j,l) / params(1+(3*(6-1)),j,l) - 0.32787_xp))                
                ...
                deriv(1+(3*(12-1)),j,l) = deriv(1+(3*(12-1)),j,l) - (lambda_r * &
                     ...
                     * (params(1+(3*(10-1)),j,l) / params(1+(3*(12-1)),j,l) - 0.32787_xp))                
